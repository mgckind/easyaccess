...
#move do_execproc() to class Do_Func in do_utils file          
...
#move do_set_password() to class Do_Func in do_utils file       
...
#move do_refresh_metadata_cache() to class Do_Func in do_utils file       
...
#move do_show_db() to class Do_Func in do_utils file       
...
#move do_myquota() to class Do_Func in do_utils file       
...
#move do_mytables() to class Do_Func in do_utils file 
...
#move do_find_user() to class Do_Func in do_utils file 
...
#move do_describe_table() to class Do_Func in do_utils file         
...
#move do_load_table() to class Do_Func in do_utils file            
